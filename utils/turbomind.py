...
class TurboMind:
    ...
    def run_subprocess(self):
        ...
        command = f"lmdeploy serve api_server {self.base_directory}{self.model_path}/workspace --model-name qwen-14b  --server-name {self.host} --server-port {self.port} --tp {count_gpu(self.gpu_id)} --backend turbomind --model-format awq"
